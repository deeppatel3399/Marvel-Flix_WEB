...
const Row2 = () => {
  ...
  useEffect(() =>{
    async function getdata(){
        ...
        setPath2(res.data.MARVELSTUDIOSORIGINALSERIES[0].data);
        setLoading(true);
    }
     getdata();
   });
  ...
  return (
    <>
      ...
      <Box className={classes.row}>
        ...
        <Typography className={classes.title}>MARVEL STUDIOS ORIGINALS SERIES</Typography>
                          ...
                          {loading ? (
                           ...
                           <Box className={classes.buttons}>
                               ...
                               <Box className={classes.btnrow}>
                                  ...
                                  <NavLink exact to={`home/series-info/${data.title}/${data.id}`}><Tooltip title="Info"><IconButton><InfoOutlinedIcon className={classes.btn}/></IconButton></Tooltip></NavLink>
                               </Box>
